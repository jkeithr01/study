...
#CREATED: 20170731
#VERSION: 1.3
#LASTMODIFIED: 20230726
#ISSUE: Update to print() from print, urllib from urllib2 for Python 3.x
#VERSION: 1.0
...
dataURL = urllib.request.urlopen(feedurl)
# respCode = '404'
